    ...
    <div class="gsp-header">
        <div class="gsp-header-content">
            ...
            <div class="gsp-header-actions">
                ...
                <a href="<?php echo esc_url(home_url('/')); ?>" class="gsp-btn gsp-btn-home gsp-btn-icon-only" title="Go to Home">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                        <polyline points="9 22 9 12 15 12 15 22"></polyline>
                    </svg>
                </a>
                <a href="<?php echo esc_url(wp_logout_url(home_url('/gsp2-login/'))); ?>" class="gsp-btn gsp-btn-logout">
